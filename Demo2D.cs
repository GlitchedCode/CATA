...
public partial class Demo2D : Control
{
  ...
  public override void _Ready()
  {
    ...
    var rule = new Model1DRule(higherOrderRule, new VonNeumann(1));
    rule.Randomize();
    originalSimulation.Rule = rule;
  ...
  public void Advance()
  {
    ...
    if(originalSimulation.Rule is MetaRule)
      (originalSimulation.Rule as MetaRule).Advance();
