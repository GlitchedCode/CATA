...
public class Model1DToRule : Rule {
  Model<Container.Array<State>> simulation;
  Neighborhood _neighborhood;
  
  public Model1DToRule(Model<Container.Array<State>> simulation, Neighborhood neighborhood) {
...
public class Model1DRule : MetaRule
{
  ...
  public Model1DRule(Rule rule, Neighborhood neighborhood)
  {
    var cellCount = Enumerable
      ...
      .Aggregate(1, (a, b) => a * b);
    simulation = new Model<Container.Array<State>>(new(cellCount, new State(1, 0)), 10);
