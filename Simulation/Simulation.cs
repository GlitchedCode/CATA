    ...
    public void Advance()
    {
        ...
        for (int r = 0; r < state.Rows; ++r)
            for (int c = 0; c < state.Columns; ++c)
            {
                ...
                neighborhood[0] = previousState.Get(r, c);
                neighborhood[1] = previousState.Get(r - 1, c);
                neighborhood[2] = previousState.Get(r, c + 1);
                neighborhood[3] = previousState.Get(r, c - 1);
                neighborhood[4] = previousState.Get(r + 1, c);
